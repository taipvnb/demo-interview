...
namespace _Demo.Scripts.AStar
{
    public class Grid2D : MonoBehaviour
    {
        ...
        {
            int x = Mathf.CeilToInt(worldPosition.x -1 + (gridSizeX / 2));
            int y = Mathf.RoundToInt(worldPosition.y -0.5f + (gridSizeY / 2));
            return Grid[x, y];
        }

        public Node2D NodeFromCoordinate(Vector2Int coor)
        {
